...
function optimizeCss(config, compilerCtx, diagnostics, styleText, filePath, legacyBuild) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const cacheKey = compilerCtx.cache.createKey('optimizeCss', 'autoprefixer9.4.3_cssnano4.1.7_postcss7.0.7_1', opts);
        const cachedContent = yield compilerCtx.cache.get(cacheKey);
        if (cachedContent != null) {
...
function bundleProjectGlobal(config, compilerCtx, buildCtx, sourceTarget, namespace, entry) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            return yield wrapGlobalJs(config, compilerCtx, buildCtx, sourceTarget, namespace, results.code);
        }
        catch (e) {
...
function minifyCore(config, compilerCtx, sourceTarget, input) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let cacheKey;
        if (compilerCtx) {
            cacheKey = compilerCtx.cache.createKey('minifyCore', '190007184553', opts, input);
            const cachedContent = yield compilerCtx.cache.get(cacheKey);
            if (cachedContent != null) {
                return {
...
function createBundle(config, compilerCtx, buildCtx, entryModules) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const rollupConfig = Object.assign({}, config.rollupConfig.inputOptions, { input: entryModules.map(b => b.filePath), experimentalCodeSplitting: true, preserveSymlinks: false, treeshake: !config.devMode, cache: config.enableCache ? compilerCtx.rollupCache : undefined, plugins: [
...
class Compiler {
    constructor(rawConfig) {
        ...
        If you need ESM output, use the '--esm' flag instead.`);
            ...
            config.logger.debug(`compiler build: 190007184553`);
